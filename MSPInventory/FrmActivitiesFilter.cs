...
{
    public partial class FrmActivitiesFilter : Form
    {
        MainFrm m_frmMain = null;
        DatabaseMgr m_dbMgr = null;
        public FrmActivitiesFilter(MainFrm frmMain, DatabaseMgr dbMgr)
        {
            InitializeComponent();
            m_frmMain = frmMain;
            m_dbMgr = dbMgr;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (cboItem.Text.Trim() != "" && cboItem.SelectedIndex != -1 && iItemID != -1)
            {
                ...
                strFilter = strFilter + (strFilter == "" ? "WHERE" : "AND") + string.Format(" a.ItemID = '{0}' ", iItemID);
            }
            ...
            if (cboModel.Text.Trim() != "" && cboModel.SelectedIndex != -1 && iModelID != -1)
            {
                ...
                strFilter = strFilter + (strFilter == "" ? "WHERE" : "AND") + string.Format(" b.ModelID = '{0}' ", iModelID);
            }
            ...
            {
                strFilter = strFilter + (strFilter == "" ? "WHERE" : "AND") + string.Format(" a.LocationTo = '{0}' ", cboLocTo.Text.Trim());
            }
            ...
            {
                strFilter = strFilter + (strFilter == "" ? "WHERE" : "AND") + string.Format(" a.ProjectID = '{0}' ", iProjectID);
            }

            if (txtStation.Text.Trim() != "" )
            {
                strFilter = strFilter + (strFilter == "" ? "WHERE" : "AND") + string.Format(" a.StationName = '{0}' ", txtStation.Text.Trim());
            }
